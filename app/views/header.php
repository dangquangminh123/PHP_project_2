...
<body>
 <header>
        <div class="info_top">
            <div class="bg_in">
                <p class="p_infor">
                    <span><i class="fa fa-envelope-o" aria-hidden="true"></i>Email: dochoimohinh@gmail.com</span>
                        ...
                        <div class="cart_wrapper">
                            <div class="cols_50">
                                <div class="hot_line_top">
                                    ...
                                    <br/>
                                    <span class="red">146A Phan Văn Trị, phường 12, quận Bình Thạnh, TP.HCM</span>
                                </div>
                            </div>
                            <div class="cols_50">
                                <div class="hot_line_top">
